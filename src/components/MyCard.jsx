...
const MyCard = ({ characterData }) => {
  const { characterData: characters, setCharacterData } =
    ...
    <div>
      <Card style={{ width: "18rem" }}>
        ...
        <Card.Body>
          ...
          <span onClick={() => addAndRemoveFavorite(characterData.id)}>
            <svg
              className="iconHeart"
            ...
            >
              <path
                fill={characterData.like ? "red" : "gray"}
